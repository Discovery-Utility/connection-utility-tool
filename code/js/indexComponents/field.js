                ...
                <div>
                  ...
                  <div id="innerHeader">
                    ...
                    <div id="configFilters">
                      ...
                      <div className="confFilt" onClick={this.filterConfiguration.bind(this, "unconfigured")} id="unconfigured">
                        <font>{mainPage_lang.formatString(mainPage_lang.filter_unconf, this.state.unconfig)}</font>
                      </div>

                      <div className="confFilt" onClick={this.filterConfiguration.bind(this, "configured")} id="configured">
                        <font>{mainPage_lang.formatString(mainPage_lang.filter_conf, this.state.config)}</font>
                      </div>

                      <div className="confFilt" onClick={this.filterConfiguration.bind(this, "service state")} id="service state">
                    ...
                    <div id="reprHeader">
                        <div className="gridForHead row">
                          ...
                          <div id="search" className="col-lg-5 col-md-8 col-sm-7">
                            <input type="text" id="searchLine" onChange={this.filterList} placeholder={mainPage_lang.filter_search}>
                            </input>
                          </div>

                          <div className="col-lg-2 col-md-4 col-sm-5">
                          <div id="typeFilters">
                            <div className="typeFilt" onClick={this.filterType.bind(this, "")} id="allSecondFilters">
                              <font>{mainPage_lang.filter_All}</font>
                            </div>

                            <div className="typeFilt typeFiltMiddle" onClick={this.filterType.bind(this, "SAN")} id="SAN">
                              <font>SAN</font>
                            </div>
                          ...
                          <div id="tooltipCluster">
                            <div id="buttonCreate" onClick={this.createClick} onMouseEnter={this.mouseEventOnCreateClick} onMouseLeave={this.mouseleaveFromCreateClick}>
                          ...
                          <div id="tooltipJoinCluster" >
                            <div id="buttonJoin" onClick={this.joinClick} onMouseEnter={this.mouseEventOnJoinClick} onMouseLeave={this.mouseleaveFromJoinClick}>
