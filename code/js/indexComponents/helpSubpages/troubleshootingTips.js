          ...
          <div className="ExpContainer">
            ...
            <div className="wteBlock">
              ...
              <div className="wteText">
                ...
                <div className="textArQR">{mainPage_lang.Troubleshoot_DocDescr1} <div className="helpLinks" onClick={this.linkTechDocs}>{mainPage_lang.Troubleshoot_DocDescr2}</div> {mainPage_lang.Troubleshoot_DocDescr3}</div>
              </div>
            </div>
          </div>
        </div>
