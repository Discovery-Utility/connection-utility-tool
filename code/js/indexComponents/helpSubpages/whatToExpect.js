        ...
        <div id="whiteSpaceForTable">
          <div className="ExpContainer">
            ...
            <div className="wteBlock">
              ...
              <div className="wteText">{mainPage_lang.formatString(mainPage_lang.WtExpect_DiscoverDescr, discTool)}</div>
            </div>
            <div className="wteBlock">
              <div className="wteNamePar">
              ...
              <div className="wteText">{mainPage_lang.formatString(mainPage_lang.WtExpect_ConfigureDescr, discTool)}</div>
            </div>
            <div className="wteBlock">
              <div className="wteNamePar">
