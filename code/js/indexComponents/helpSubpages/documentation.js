      ...
      <div id="logShow">
        ...
        <div id="whiteSpaceForTable">
          <div className="ExpContainer">
            <div>{mainPage_lang.Documentation_descr1} <div className="helpLinks" onClick={this.docLinks}>{mainPage_lang.formatString(mainPage_lang.Documentation_descr2, productName)}</div> {mainPage_lang.Documentation_descr3}</div>
