...
class Appliance extends React.Component{
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      /* The variable is responsible for highlighting the appliances: "true" - are not selected, "false" - is selected*/ positon: true
    };
  }
...
// "box" hover
  ...
  rendNorm ()
  {
    ...
    return (
    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-12 gridEl" > {/* To display all devices, use the Grid from the Bootstrap library */}
        <div className="box" onClick={this.selectApp} id={this.props.ssn} onMouseEnter={this.boxHover} onMouseLeave={this.offBoxHover}>
          <img className="boxStateIcon" src={"icon/dell_logo.png"}/>
          <div className="boxInfo">
            <div><font> {mainPage_lang.formatString(mainPage_lang.applianceinfo_Appliance, this.props.type)}</font></div>
