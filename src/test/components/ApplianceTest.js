...
describe("Appliance component tests", () => {
    ...
    it("Should render appliance with radio checkmark", () => {
        ...
        expect(wrapper.find(".appliance")).to.have.lengthOf(1);
        expect(wrapper.find("[type='radio']")).to.have.lengthOf(1);
    ...
    it('Should call "addSelection" after clicking on inactive radiobutton ', () => {
        const addCallback = sinon.spy();
        const wrapper = shallow(
    ...
    it('Should call "addSelection" after clicking on already active radiobutton', () => {
        const addCallback = sinon.spy();
