...
class WelcomePage extends Component {
    constructor(props) {
        ...
        this.getConnectYourLaptop = () => {
            return     <div className="wteBlock">
                            <div>{t.CONNECT_LAPTOP_TEXT}</div>
                            <div className="ttText">
                                <ul>
                                    <li>{t.ConnectLaptopLi1}</li>
                                    <li>{t.ConnectLaptopLi2}</li>
                                </ul>
                            </div>
                        </div>
	}
        ...
        this.getDisableNetwork = () => {
            return      <div className="wteBlock">
				<div>{t.DISABLE_NETWORK_TEXT}</div><br></br>
       ...
       this.getDisableFirewallBody = () => {
	    return    <div className="wteBlock">
                          <div>{t.DISABLE_FIREWALL_TEXT}</div><br></br>
                          <div>{t.DISABLE_FIREWALL_TEXT2}</div><br></br>
                          <div>{t.DISABLE_FIREWALL_TEXT3}</div><br></br>
	...
	this.getBackupDiscovery = () => {
			...
			<ol type="1">
				...
				<li>{t.BACKUP_DISCOVERY4}<br></br><br></br>
	                                <div>{t.BACKUP_DISCOVERY_COMMAND}</div><br></br>
			        </li>
        ...
        return (
            <div>
                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        <p className="show-link" data-toggle="modal" data-target="#modal" onClick={this.clickOnShowBackupDiscovery}>  {t.SHOW_BACKUP_DISCOVERY}</p>
                    </div>
